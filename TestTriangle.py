...
class TestTriangles(unittest.TestCase):
    ...
    def testRightTriangle03(self):
        self.assertEqual(classifyTriangle(28, 195, 197), 'Right',
    ...
    def testIsoscelesTriangle03(self):
        self.assertEqual(classifyTriangle(200, 200, 1), 'Isosceles',
                         '200, 200, 1 is an Isosceles')
                        
    # Flipped Order 2
    def testIsoscelesTriangle04(self):
        self.assertEqual(classifyTriangle(200, 1, 200), 'Isosceles',
    ...
    def testScaleneTriangle01(self):
        self.assertEqual(classifyTriangle(7, 12, 15), 'Scalene',
                         '7, 12, 15 should be Scalene')

    # Flipped Order
    def testScaleneTriangle02(self):
        self.assertEqual(classifyTriangle(15, 7, 12), 'Scalene',
    ...
    def testInvalidInput02(self):
        self.assertEqual(classifyTriangle(1, 1, math.sqrt(2)), 'InvalidInput',
    ...
    def testInvalidInput04(self):
        self.assertEqual(classifyTriangle(1.2, 1.2, 1.2), 'InvalidInput',
                         '1.2, 1.2, 1.2 is invalid')

    # non-int string
    def testInvalidInput05(self):
        self.assertEqual(classifyTriangle("a", "a", "a"), 'InvalidInput',
                         '"a", "a", "a" is invalid')
    ...
    def testNotATriangleInput02(self):
        self.assertEqual(classifyTriangle(30, 15, 10),
                         'NotATriangle', '30, 15, 10 is a Not a Triangle')
                        
    # Flipped Order 2
    def testNotATriangleInput03(self):
        self.assertEqual(classifyTriangle(10, 30, 15),
